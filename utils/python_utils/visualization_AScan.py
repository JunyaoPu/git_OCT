...
if __name__ == '__main__':
    ...
    parse_OCTMPS_output_files(('Class I OCT signal and its variance at different depths using 10^7 photons',
                               '../../output/journal_paper_variance_comparison/using_10^7_photons/ClassII_ScattFilt.out'), show_variance=True)
